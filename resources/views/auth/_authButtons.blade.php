...
<div class="form-group">
    <div class="col-md-6 col-md-offset-4">
        ...
        <div class="authButton">
            ...
            <a  class="btn btn-info " id="" href="/auth/facebook" role="button"><i class="fa fa-facebook-square fa-2x"></i> <span style="vertical-align:top;">Continue with Facebook</span></a>
