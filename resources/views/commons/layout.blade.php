...
<head>
    ...
    {{--<script type="text/javascript" src="/js/customJs/socialIcons.js"></script>--}}
    {{--<script type="text/javascript" src="/js/customJs/searchBar.js"></script>--}}
    {{--<script type="text/javascript" src="/js/customJs/custom.js"></script>--}}
    {{--<script type="text/javascript" src="/js/customJs/subscription.js"></script>--}}
</head>
<body>
